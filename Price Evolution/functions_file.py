...
def CompinedPriceEvolution(meanPrices, quantileMeanPrices, constraint, ymax, title="none", figsize=(14,3), fontsize=12, dpi=200):

    # Create figure
    fig = plt.figure(figsize=figsize,dpi=dpi) # Figure size and quality
    gs = fig.add_gridspec(1, 11) # Grid size
    ...
    axs.append( fig.add_subplot(gs[0,8:11]) )    # Plot 3: Elec sector coupled prices
