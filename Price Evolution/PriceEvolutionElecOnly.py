...
fig = PriceEvolution(meanPriceElec,quantileMeanPriceElecC, quantileMinPriceElecC, ylim=140, networktype="green", title=title, figsize=[6,3.2], fontsize=16)
title =  (file[12:-14] + " - ENP Trans Evolution")
path = figurePath + "flat average (countries)\\"
SavePlot(fig, path, title)

# ----------------------- Price evalution (Elec) --------------------#
title = "Elec NP Trans Evolution (flat average across time)"
fig = PriceEvolution(meanPriceElec,quantileMeanPriceElecT, quantileMinPriceElecT, ylim=240, networktype="green", title=title, figsize=[6,3.2], fontsize=16)
title =  (file[12:-14] + " - ENP Trans Evolution")
path = figurePath + "flat average (time)\\"
SavePlot(fig, path, title)
...
fig = PriceEvolution(meanPriceElecWC,quantileMeanPriceElecWC, quantileMinPriceElecC, ylim=140, networktype="green", title=title, figsize=[6,3], fontsize=16)
title =  (file[12:-14] + " - ENP Trans Evolution")
path = figurePath + "weighted average (countries)\\"
SavePlot(fig, path, title)
...
fig = PriceEvolution(meanPriceElecWT,quantileMeanPriceElecWT, quantileMinPriceElecT, ylim=240, networktype="green", title=title, figsize=[6,3], fontsize=16)
title =  (file[12:-14] + " - ENP Trans Evolution")
path = figurePath + "weighted average (time)\\"
SavePlot(fig, path, title)