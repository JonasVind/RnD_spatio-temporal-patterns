...
# Correction
eigenVectorsRealENP = AlignEigenVectors(eigenVectorsRealENP, realPrices.columns, country="ES")
...
# Correction
eigenVectorsElecOnly = AlignEigenVectors(eigenVectorsElecOnly, priceElecOnly.columns, country="ES")
...
# Correction
eigenVectorsElecSector = AlignEigenVectors(eigenVectorsElecSector, priceElecSector.columns, country="ES")
...
for i in range(3):
    ...
    # plot PC1
    T_avg_day[3] = T_avg_day[3]+offsetValue # add offset
    T_avg_day[3].values[T_avg_day[3].values >  6] =  6 # Remove values higher than 0
    T_avg_day[3].values[T_avg_day[3].values <  2] =  2 # Remove values lower than 0
    axs[i].plot(x_ax,T_avg_day[3],color=color[3]) # Plot
    # plot PC2
    T_avg_day[4] = T_avg_day[4]
    T_avg_day[4].values[T_avg_day[4].values >  2] =  2 # Remove values higher than 0
    T_avg_day[4].values[T_avg_day[4].values < -2] = -2 # Remove values lower than 0
    axs[i].plot(x_ax,T_avg_day[4],color=color[4]) # Plot
    # plot PC2
    T_avg_day[5] = T_avg_day[5]-offsetValue
    T_avg_day[5].values[T_avg_day[5].values > -2] = -2 # Remove values higher than 0
    T_avg_day[5].values[T_avg_day[5].values < -6] = -6 # Remove values lower than 0
    axs[i].plot(x_ax,T_avg_day[5],color=color[5]) # Plot
...
#%% Plot and save
path = figurePath
title = "Comparison between Electricity Only and Real Prices (ANNEX)"
...
# Correction
eigenVectorsElecOnly = AlignEigenVectors(eigenVectorsElecOnly, mismatchElec.columns, country="ES")
...
# Correction
eigenVectorsElecSector = AlignEigenVectors(eigenVectorsElecSector, mismatchElec.columns, country="ES")
...
for i in range(2):
    ...
    # plot PC1
    T_avg_day[3] = T_avg_day[3]+offsetValue # add offset
    T_avg_day[3].values[T_avg_day[3].values >  6] =  4.5 # Remove values higher than 0
    T_avg_day[3].values[T_avg_day[3].values <  2] =  1.5 # Remove values lower than 0
    axs[i].plot(x_ax,T_avg_day[3],color=color[3]) # Plot
    # plot PC2
    T_avg_day[4] = T_avg_day[4]
    T_avg_day[4].values[T_avg_day[4].values >  2] =  1.5 # Remove values higher than 0
    T_avg_day[4].values[T_avg_day[4].values < -2] = -1.5 # Remove values lower than 0
    axs[i].plot(x_ax,T_avg_day[4],color=color[4]) # Plot
    # plot PC2
    T_avg_day[5] = T_avg_day[5]-offsetValue
    T_avg_day[5].values[T_avg_day[5].values > -2] = -1.5 # Remove values higher than 0
    T_avg_day[5].values[T_avg_day[5].values < -6] = -4.5 # Remove values lower than 0
    axs[i].plot(x_ax,T_avg_day[5],color=color[5]) # Plot
...
#%% Plot and save
path = figurePath
title = "Comparison between Electricity Only and Electricity Sector (Annex)"
