...
for i in range(2):
    ...
    # add zero value
    axs[i].hlines(2,-50,400 ,colors="k", linestyles= "--", linewidth=1,alpha=0.5)
    #axs[i].hlines(0,-50,400 ,colors="k", linestyles= "--", linewidth=1,alpha=0.5)
    axs[i].hlines(-2,-50,400 ,colors="k", linestyles= "--", linewidth=1,alpha=0.5)
    # Mid axis
    axs[i].hlines(0,-50,400 ,colors="k",linewidth=1,)
...
#%% Plot and save
path = figurePath
title = "Comparison between Heating Prices and Mismatch"
